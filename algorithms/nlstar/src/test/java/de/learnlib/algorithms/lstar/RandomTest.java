...
public final class RandomTest {
    ...
    public static void main(String[] args) {
        ...
        CompactDFA<Integer> dfa = RandomAutomata.randomDFA(new Random(), 50, alphabet);
        ...
        ExtensibleLStarDFA<Integer> lstar = new ExtensibleLStarDFABuilder<Integer>().withAlphabet(alphabet)
                                                                                    .withOracle(cache2)
                                                                                    .withCexHandler(
