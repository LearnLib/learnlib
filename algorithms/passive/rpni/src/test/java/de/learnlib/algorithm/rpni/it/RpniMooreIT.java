...
import de.learnlib.algorithm.rpni.BlueFringeRPNIMoore;
...
import de.learnlib.testsupport.it.learner.AbstractMoorePassiveLearnerIT;
import de.learnlib.testsupport.it.learner.PassiveLearnerVariantList;
import net.automatalib.alphabet.Alphabet;
import net.automatalib.automaton.transducer.MooreMachine;
import net.automatalib.word.Word;

public class RpniMooreIT extends AbstractMoorePassiveLearnerIT {
        ...
        for (boolean d : determinism) {
            for (boolean p : parallelism) {
                for (ProcessingOrder o : orders) {
                    final BlueFringeRPNIMoore<I, O> learner = new BlueFringeRPNIMoore<>(alphabet);
