 ...
 */
package de.learnlib.algorithm.lambda.ttt.dfa.it;
...
@Test
public class TTTLambdaDFAIT extends AbstractDFALearnerIT {
    ...
    protected <I> void addLearnerVariants(Alphabet<I> alphabet,
        ...
        variants.addLearnerVariant("TTTLambdaDFA", new TTTLambdaDFA<>(alphabet, mqOracle));
    }
