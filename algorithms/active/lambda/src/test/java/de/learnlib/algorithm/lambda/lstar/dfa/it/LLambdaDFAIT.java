 ...
 */
package de.learnlib.algorithm.lambda.lstar.dfa.it;
...
@Test
public class LLambdaDFAIT extends AbstractDFALearnerIT {
    ...
    protected <I> void addLearnerVariants(Alphabet<I> alphabet,
        ...
        variants.addLearnerVariant("LLambdaDFA", new LLambdaDFA<>(alphabet, mqOracle));
    }
