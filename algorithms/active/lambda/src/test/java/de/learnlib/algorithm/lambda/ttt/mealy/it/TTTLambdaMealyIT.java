 ...
 */
package de.learnlib.algorithm.lambda.ttt.mealy.it;
...
@Test
public class TTTLambdaMealyIT extends AbstractMealyLearnerIT {
    ...
    protected <I, O> void addLearnerVariants(Alphabet<I> alphabet,
        ...
        variants.addLearnerVariant("TTTLambdaMealy", new TTTLambdaMealy<>(alphabet, mqOracle));
    }
