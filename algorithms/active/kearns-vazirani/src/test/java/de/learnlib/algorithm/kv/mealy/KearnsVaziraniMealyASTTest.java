...
public class KearnsVaziraniMealyASTTest extends AbstractLearnerASTMealyTest<KearnsVaziraniMealy<Character, Character>> {

    @Override
    protected KearnsVaziraniMealy<Character, Character> getLearner(MealyMembershipOracle<Character, Character> oracle,
                                                                   Alphabet<Character> alphabet) {
        return new KearnsVaziraniMealyBuilder<Character, Character>().withAlphabet(alphabet)
                                                                     .withOracle(oracle)
                                                                     .create();
    }
    ...
    protected Collection<Word<Character>> getTrueRepresentatives() {
        MultiDTree<Character, Word<Character>, StateInfo<Character, Word<Character>>> dt =
