...
public class LSharpMealyASTTest
        extends AbstractLearnerASTTest<LSharpMealy<Integer, Character>, MealyMachine<?, Integer, ?, Character>, AdaptiveMembershipOracle<Integer, Character>, Integer, Word<Character>> {
    ...
    @Override
    protected LSharpMealy<Integer, Character> getLearner(AdaptiveMembershipOracle<Integer, Character> oracle,
                                                         Alphabet<Integer> alphabet) {
        return new LSharpMealy<>(alphabet, oracle);
    }

    @Override
    protected Collection<Word<Integer>> getTrueRepresentatives() {
        return learner.getAccessMap();
    }
}
