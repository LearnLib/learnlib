...
public class OptimalLStarDFAResumableTest extends AbstractResumableLearnerDFATest<OptimalLStarDFA<Character>, OptimalLStarState<Character, Boolean>> {

    @Override
    protected OptimalLStarDFA<Character> getLearner(DFAMembershipOracle<Character> oracle,
