...
import de.learnlib.algorithms.spmm.adapter.KearnsVaziraniMealyAdapter;
import de.learnlib.algorithms.spmm.adapter.LStarBaseMealyAdapter;
import de.learnlib.algorithms.spmm.adapter.RivestSchapireMealyAdapter;
import de.learnlib.algorithms.spmm.adapter.TTTMealyAdapter;
import de.learnlib.algorithms.spmm.manager.DefaultATManager;
...
public class SPMMIT extends AbstractSPMMLearnerIT {
    ...
    protected <I, O> void addLearnerVariants(SPAAlphabet<I> alphabet,
        ...
        builder.addLearnerVariant(DiscriminationTreeMealyAdapter::new);
        builder.addLearnerVariant(KearnsVaziraniMealyAdapter::new);
        builder.addLearnerVariant(LStarBaseMealyAdapter::new);
        builder.addLearnerVariant(RivestSchapireMealyAdapter::new);
        builder.addLearnerVariant(TTTMealyAdapter::new);
    }
