...
/**
 * Adapter for using {@link ExtensibleLStarMealy} as a sub-procedural learner.
 *
 * @param <I>
 *         input symbol type
 * @param <O>
 ...
 * @author frohme
 */
public class LStarBaseMealyAdapter<I, O> extends ExtensibleLStarMealy<I, O> implements AccessSequenceTransformer<I> {

    public LStarBaseMealyAdapter(Alphabet<I> alphabet, MembershipOracle<I, Word<O>> oracle) {
        super(alphabet,
              oracle,
