...
import de.learnlib.testsupport.AbstractLearnerASTMooreTest;
import net.automatalib.alphabet.Alphabet;
import net.automatalib.common.util.collection.IteratorUtil;
import net.automatalib.word.Word;

public class OPLearnerMooreASTTest extends AbstractLearnerASTMooreTest<OPLearnerMoore<Character, Character>> {

    @Override
    protected OPLearnerMoore<Character, Character> getLearner(MooreMembershipOracle<Character, Character> oracle,
                                                              Alphabet<Character> alphabet) {
        return new OPLearnerMoore<>(alphabet, oracle);
    }

    @Override
    protected Collection<Word<Character>> getTrueRepresentatives() {
        final AbstractWordBasedDiscriminationTree<Character, Word<Character>, HState<Character, Word<Character>, Character, Void>>
                dt = learner.getDiscriminationTree();
