...
import de.learnlib.algorithm.util.AbstractMealyASTTest;
import de.learnlib.oracle.MembershipOracle.MealyMembershipOracle;
import net.automatalib.alphabet.Alphabet;

public class ExtensibleLStarMealyASTTest extends AbstractMealyASTTest {

    @Override
    protected ExtensibleLStarMealy<Character, Character> getLearner(MealyMembershipOracle<Character, Character> oracle,
                                                                    Alphabet<Character> alphabet) {
        return new ExtensibleLStarMealy<>(alphabet, oracle);
    }
