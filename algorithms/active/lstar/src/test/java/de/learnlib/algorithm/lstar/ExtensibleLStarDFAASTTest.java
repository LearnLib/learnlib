...
import de.learnlib.algorithm.util.AbstractDFAASTTest;
import de.learnlib.oracle.MembershipOracle.DFAMembershipOracle;
import net.automatalib.alphabet.Alphabet;

public class ExtensibleLStarDFAASTTest extends AbstractDFAASTTest {

    @Override
    protected ExtensibleLStarDFA<Character> getLearner(DFAMembershipOracle<Character> oracle,
                                                       Alphabet<Character> alphabet) {
        return new ExtensibleLStarDFA<>(alphabet, oracle);
    }
