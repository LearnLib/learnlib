...
public abstract class AbstractDFAASTTest extends AbstractLearnerASTDFATest<ExtensibleLStarDFA<Character>> {

    @Override
    protected Collection<Word<Character>> getTrueRepresentatives() {
        final ObservationTable<Character, Boolean> ot = learner.getObservationTable();
