...
public class TTTLearnerMooreASTTest extends AbstractLearnerASTMooreTest<TTTLearnerMoore<Character, Character>> {

    @Override
    protected TTTLearnerMoore<Character, Character> getLearner(MooreMembershipOracle<Character, Character> oracle,
                                                               Alphabet<Character> alphabet) {
        return new TTTLearnerMoore<>(alphabet, oracle);
    }

    @Override
    protected Collection<Word<Character>> getTrueRepresentatives() {
        final BaseTTTDiscriminationTree<Character, Word<Character>> dt = learner.getDiscriminationTree();
