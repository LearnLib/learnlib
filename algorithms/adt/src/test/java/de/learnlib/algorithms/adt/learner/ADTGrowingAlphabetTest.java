 ...
 * @author frohme
 */
public class ADTGrowingAlphabetTest extends AbstractGrowingAlphabetTest<
		ADTLearner<Integer, Character>,
		MealyMachine<?, Integer, ?, Character>,
		SymbolQueryOracle<Integer, Character>,
		Integer,
		Word<Character>
		> {
	...
	@Override
	protected ADTLearner<Integer, Character> getLearner(SymbolQueryOracle<Integer, Character> oracle, Alphabet<Integer> alphabet) {
