...
public class ADT<S, I, O> implements Serializable {
	 ...
	 *
	 * @param state the referenced state of the leaf
	 */
	 ...
	 *
	 * @param nodeToSplit          the leaf node to extends
	 * @param distinguishingSuffix the input sequence that splits the hypothesis state of the leaf to split and the
	 *                             new node. The current trace leading into the node to split must be a prefix of this
	 *                             word.
