...
public class ADTUtil {
	...
	/**
	 * Utility method that wraps a ADS of type {@link ADSNode} into the equivalent ADS of
	 * type {@link ADTNode}.
	 *
	 * @param node the root node of the ADS
	 ...
	 *
	 * @param adt the node whose subtree should be analyzed
	 * @param <S> (hypothesis) state type
	 * @param <I> input alphabet type
	 * @param <O> output alphabet type
	 ...
	 *
	 * @param input      the input sequence of the trace
	 * @param output     the output sequence of the trace
	 * @param finalState the hypothesis state that should be referenced in the leaf of the ADS
	 * @param <S>        (hypothesis) state type
	 * @param <I>        input alphabet type
	 * @param <O>        output alphabet type
	 ...
	 *
	 * @param parent the parent ADS in which the given child ADS should be merged into
	 * @param child  the (single trace) ADS which should be incorporated into the parent ADS.
	 * @param <S>    (hypothesis) state type
	 * @param <I>    input alphabet type
	 * @param <O>    output alphabet type
