...
/**
 * A class that describes the possible result a {@link de.learnlib.algorithms.adt.api.SubtreeReplacer} can return. A
 * replacement may either be <ul> <li> a complete replacement </li> <li> a partial replacement, that additionally
 * defines which hypothesis states are not covered by the replacement </li> </ul>
 *
 * @param <S>
...
public class ReplacementResult<S, I, O> {
    ...
    /**
     * The {@link de.learnlib.algorithms.adt.adt.ADT} subtree (root-node) that forms the replacement.
     *
    ...
    /**
     * The {@link de.learnlib.algorithms.adt.adt.ADT} subtree (root-node) that should be replaced.
     *
