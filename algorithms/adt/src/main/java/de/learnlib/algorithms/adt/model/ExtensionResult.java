...
/**
 * A class that describes the possible result a {@link de.learnlib.algorithms.adt.api.ADTExtender} can return.
 * Extending a parent trace can either
 * <ul>
 * <li>
...
public class ExtensionResult<S, I, O> {
	...
	private final static ExtensionResult<?, ?, ?> EMPTY = new ExtensionResult();
