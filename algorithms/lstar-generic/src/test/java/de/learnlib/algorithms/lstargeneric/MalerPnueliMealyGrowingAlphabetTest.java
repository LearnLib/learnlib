...
public class MalerPnueliMealyGrowingAlphabetTest
		extends AbstractGrowingAlphabetMealyTest<MalerPnueliMealy<Integer, Character>> {

	@Override
	protected MalerPnueliMealy<Integer, Character> getLearner(MembershipOracle<Integer, Word<Character>> oracle,
