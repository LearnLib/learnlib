 ...
 * @param <T> link structure type
 * @param <N> node type
 *
 * @author frohme
 */
public abstract class TemporaryIntrusiveDTNode<DSCR, O, D, T extends IntrusiveList<?>, N extends TemporaryIntrusiveDTNode<DSCR, O, D, T, N>>
	...
	public TemporaryIntrusiveDTNode(N parent, O parentOutcome, D data) {
