...
public enum Type {
    DFA {
        ...
        public Runner<?, ?, ?, ?> runner() {
            return new Runner<>(AlphabetFactory.REGULAR,
                                MQOFactory.ACCEPTOR,
    ...
    SBA {
        @Override
        public Runner<?, ?, ?, ?> runner() {
            return new Runner<>(AlphabetFactory.PROCEDURAL,
                                MQOFactory.ACCEPTOR,
    ...
    VPA {
        @Override
        public Runner<?, ?, ?, ?> runner() {
            return new Runner<>(AlphabetFactory.VPA,
                                MQOFactory.ACCEPTOR,
