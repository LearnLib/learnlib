...
public class RPNITest {
	...
	private List<List<DefaultQuery<Integer,Boolean>>> sampleSets
		= new ArrayList<>();
	
	private List<List<DefaultQuery<Integer,Word<String>>>> sampleSetsMealy
		= new ArrayList<>();
	...
	public void setUp() {
		...
		CompactMealy<Integer,String> mealy = RandomAutomata.randomMealy(new Random(), 100, alphabet, Arrays.asList("foo", "bar"));
		sampleSetsMealy.add(createSample(new Random(2), mealy, alphabet, 100, 30));
	}
	
	private <I,D> List<DefaultQuery<I,D>> createSample(Random r, Output<I, D> out, Alphabet<I> inputs,
	...
	private <I,D,M extends SuffixOutput<I,D>> void testLearner(
			PassiveLearningAlgorithm<M,I,D> learner,
