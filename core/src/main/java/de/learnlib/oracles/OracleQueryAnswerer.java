...
/**
 * A {@link QueryAnswerer} that queries a {@link MembershipOracle} for implementing the {@link #answerQuery(Word, Word)}
 * method.
 *
 * @param <I>
 *         input symbol type
 ...
 * @deprecated since 2015-05-10. {@link MembershipOracle} now extends {@link QueryAnswerer}, rendering this class
 * obsolete.
 */
@Deprecated
