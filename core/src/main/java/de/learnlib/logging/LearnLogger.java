...
import de.learnlib.statistics.AbstractStatisticData;
...
public interface LearnLogger extends Logger {
     ...
     */
    default void logProfilingInfo(AbstractStatisticData profiling) {
     ...
     * log statistic info.
     */
    default void logStatistic(AbstractStatisticData statistics) {
