...
public class StaticParallelSLISULTest extends AbstractStaticParallelOracleTest<Word<TestSULOutput>> {

    @Override
    protected StaticParallelOracleBuilder<Integer, Word<TestSULOutput>> getBuilder() {
        // since we fork our initial SUL, start at -1
        return ParallelOracleBuilders.newStaticParallelOracle(new TestSUL(new AtomicInteger(-1)), null);
    }
