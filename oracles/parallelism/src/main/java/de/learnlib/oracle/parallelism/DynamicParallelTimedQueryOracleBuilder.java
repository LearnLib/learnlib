...
public class DynamicParallelTimedQueryOracleBuilder<I, O>
    ...
    @Override
    protected DynamicParallelTimedQueryOracle<I, O> buildOracle(Supplier<? extends TimedQueryOracle<I, O>> supplier,
                                                                int minBatchSize,
                                                                ExecutorService executor) {
        return new DynamicParallelTimedQueryOracle<>(supplier, minBatchSize, executor);
    }
}
