...
public class ModelCheckingBBPropertyTest {
    ...
    @Test
    public void testDisproveUncached() throws Exception {
    ...
    @Test
    public void testDisproveCached() throws Exception {
        mcbbp.useCache();
    ...
    @Test
    public void testFindCounterExampleUncached() throws Exception {
    ...
    @Test
    public void testFindCounterExampleCached() throws Exception {
        mcbbp.useCache();
