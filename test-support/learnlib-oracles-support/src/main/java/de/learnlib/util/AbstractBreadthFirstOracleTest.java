...
public abstract class AbstractBreadthFirstOracleTest<D> {
    ...
    protected abstract AbstractBreadthFirstOracle<? extends SimpleDTS<?, Character>, Character, D, ? extends Query<Character, D>>
    ...
    @Test
    public void testGetMaxWords() throws Exception {
