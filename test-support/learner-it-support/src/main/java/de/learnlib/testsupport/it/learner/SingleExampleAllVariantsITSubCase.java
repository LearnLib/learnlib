...
final class SingleExampleAllVariantsITSubCase<I, D, A extends UniversalDeterministicAutomaton<?, I, ?, ?, ?> & SuffixOutput<I, D>> {

    private final LearningExample<I, D, ? extends A> example;
    private final LearnerVariantListImpl<? extends A, I, D> variants;

    SingleExampleAllVariantsITSubCase(LearningExample<I, D, ? extends A> example,
