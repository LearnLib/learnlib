 ...
 *
 * //TODO: Integrate into existing IT landscape. (Needs refactoring, because VPDAs are no
 * {@link net.automatalib.automata.UniversalAutomaton})
 *
 * @author frohme
 */
public abstract class AbstractVPDALearnerIT {
	...
	private final static int LOC_COUNT = 100;
	private final static double ACCEPTANCE_PROB = 0.5;
	private final static double RETURN_PROB = 0.5;

	private final static Alphabet<Character> CALL_ALPHABET = Alphabets.fromArray('1', '2', '3');
	private final static Alphabet<Character> INTERNAL_ALPHABET = Alphabets.characters('a', 'f');
	private final static Alphabet<Character> RETURN_ALPHABET = Alphabets.fromArray('7', '8', '9');

	private final static VPDAlphabet<Character> VPD_ALPHABET =
	...
	/**
	 * Adds, for a given setup, all the variants of the OneSEVPA learner to be tested
	 ...
	 */
	protected abstract <I> void addLearnerVariants(final VPDAlphabet<I> alphabet,
